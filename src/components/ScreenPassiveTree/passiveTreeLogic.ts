...
export class PassiveTreeManager {
	...
	private readonly ascendancyData: Record<
		string,
		{ nodes: string[]; transform: string }
	> = {
		Deadeye: {
			nodes: [
				"30",
			...
			transform: "translate(-15794.84, -3546.05)",
		},
		Pathfinder: {
			nodes: [
				"16",
			...
			transform: "translate(-14882.62, -6487.42)",
		},
		Amazon: {
			nodes: [
				"528",
			...
			transform: "translate(-12808.37, -9364.84)",
		},
		Ritualist: {
			nodes: [
				"3223",
			...
			transform: "translate(-10845.71, -11735.18)",
		},
		Titan: {
			nodes: [
				"3762",
			...
			transform: "translate(11977.41, -10636.41)",
		},
		Warbringer: {
			nodes: [
				"1994",
			...
			transform: "translate(14246.82, -7955.35)",
		},
		"Smith of Kitava": {
			nodes: [
				"110",
			...
			transform: "translate(15205.33, -5282.12)",
		},
		Tactician: {
			nodes: [
				"762",
			...
			transform: "translate(-3277.38, -15697.95)",
		},
		Witchhunter: {
			nodes: [
				"3704",
			...
			transform: "translate(-26.88, -16189.06)",
		},
		"Gemling Legionnaire": {
			nodes: [
				"1442",
			...
			transform: "translate(3250.95, -15406.05)",
		},
		Oracle: {
			nodes: [
				"378",
			...
			transform: "translate(14279.65, 6881.06)",
		},
		Shaman: {
			nodes: [
				"1855",
			...
			transform: "translate(12279.12, 9183.00)",
		},
		Infernalist: {
			nodes: [
				"770",
			...
			transform: "translate(9444.91, 13185.83)",
		},
		"Blood Mage": {
			nodes: [
				"3165",
			...
			transform: "translate(6319.78, 14714.00)",
		},
		Lich: {
			nodes: [
				"59",
			...
			transform: "translate(3396.68, 15843.95)",
		},
		Stormweaver: {
			nodes: [
				"2857",
			...
			transform: "translate(-0.00, 16231.29)",
		},
		Chronomancer: {
			nodes: [
				"1579",
			...
			transform: "translate(-3230.06, 15709.82)",
		},
		"Disciple of Varashta": {
			...
			transform: "translate(-6262.26, 14753.35)",
		},
		Invoker: {
			nodes: [
				"7621",
			...
			transform: "translate(-13267.15, 9481.90)",
		},
		"Acolyte of Chayula": {
			nodes: [
				"74",
			...
			transform: "translate(-14833.95, 6460.32)",
		},
	};
