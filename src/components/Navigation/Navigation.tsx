...
import { kAppScreens, kAppStatus } from "../../config/enums";
...
export function Navigation({ className }: NavigationProps) {
	...
	const _setStatus = (newStatus: kAppStatus) => {
	...
	return (
		<div className={classNames("Navigation", className)}>
			...
			{/* <button */}
			{/* 	className={classNames("menu-secondary", "menu-premium", { */}
			...
			{/* 	<p> */}
			{/* 		We recommend creating a dedicated area where you can provide detailed */}
			{/* 		information about the apps various subscription plans. This area could */}
			{/* 		also serve as a feedback channel for your subscribed users to view */}
			{/* 		their active subscriptions and manage them effectively. */}
			{/* 	</p> */}
			{/* </Tip> */}
			{/**/}
			{/* <div className={classNames("menu-secondary", "menu-status", statusClass)}> */}
			{/* 	Status */}
			{/* 	<br /> */}
			{/* 	Simulator */}
			...
			{/* 	<p> */}
			{/* 		Click to toggle between various app statuses. It&apos;s important to */}
			{/* 		keep users informed about the app&apos;s operational status. We */}
			{/* 		recommend using a real time status indicator synced with Overwolf to */}
			{/* 		ensure accurate event tracking and issue detection. For further */}
			{/* 		details on event status, please visit this&nbsp; */}
			{/* 		<Link url="https://overwolf.github.io/topics/using-events/how-to-check-events-status-from-app"> */}
			{/* 			link */}
			{/* 		</Link> */}
			{/* 		. */}
			{/* 	</p> */}
			...
			{/* 	<h6>Settings</h6> */}
			{/* 	<p> */}
			{/* 		It&apos;s recommended to position your settings either on the top bar */}
			{/* 		or side bar, distinct from the main app tabs. This is where users can */}
			{/* 		customize their hotkeys, overlay, app behavior, and other relevant */}
